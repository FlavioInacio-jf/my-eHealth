...
public class ViewConstants {
    ...
    public static final Color GREEN_COLOR = new Color(0, 138, 99);
    public static final Color RED_COLOR = new Color(151, 35, 2);
    public static final Color YELLOW_COLOR = new Color(212, 165, 24);
    ...
    public static final String UPDATE_PERSON_VIEW_TITLE = "Cadastrar Paciente";
    ...
    public static final String UPDATE_HEALTH_UNIT_TITLE = "Atualizar unidade de saúde";
