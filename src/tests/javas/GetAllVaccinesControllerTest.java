...
import javas.modules.vaccine.useCases.getAllVaccines.GetAllVaccinesController;
...
public class GetAllVaccinesControllerTest {
    IVaccineRepository vaccineRepository;
    GetAllVaccinesUseCase getAllVaccinesUseCase;
    public GetAllVaccinesControllerTest() {
        this.vaccineRepository = new VaccineRepository();
        this.getAllVaccinesUseCase = new GetAllVaccinesUseCase(this.vaccineRepository);
    }

    @Test
    public void testExecute() {
        GetAllVaccinesController getAllVaccinesController = new GetAllVaccinesController(this.getAllVaccinesUseCase);
